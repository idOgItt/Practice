...
namespace __detail
{
    ...
    template<typename tkey, typename tvalue, typename compare>
    void bst_impl<tkey, tvalue, compare, AVL_TAG>::post_search(
            binary_search_tree<tkey, tvalue, compare, AVL_TAG>::node **node)
    {
        throw not_implemented("template<typename tkey, typename tvalue, typename compare>\n"
                              "void bst_impl<tkey, tvalue, compare, AVL_TAG>::post_search(\n"
                              "binary_search_tree<tkey, tvalue, compare, AVL_TAG>::node **)", "your code should be here...");
    }
...
template<typename tkey, typename tvalue, compator<tkey> compare>
AVL_tree<tkey, tvalue, compare>::prefix_reverse_iterator::operator prefix_iterator() const noexcept
{
...
template<typename tkey, typename tvalue, compator<tkey> compare>
AVL_tree<tkey, tvalue, compare>::prefix_const_reverse_iterator::operator prefix_const_iterator() const noexcept
{
...
template<typename tkey, typename tvalue, compator<tkey> compare>
typename AVL_tree<tkey, tvalue, compare>::infix_const_reverse_iterator AVL_tree<tkey, tvalue, compare>::crend_infix() const nonexcept
{
...
// region AVL_tree additional constructors

template<typename compare, typename U, typename iterator>
AVL_tree(iterator begin, iterator end, const compare& cmp, pp_allocator<U> alloc, logger* logger)
-> AVL_tree<const typename std::iterator_traits<iterator>::value_type::first_type,
        typename std::iterator_traits<iterator>::value_type::second_type, compare>
{
    throw not_implemented("template<typename compare, typename U, typename iterator>\n"
                          "AVL_tree(iterator , iterator , const compare& , pp_allocator<U> , logger* )\n"
                          "-> AVL_tree<const typename std::iterator_traits<iterator>::value_type::first_type,\n"
                          "typename std::iterator_tr aits<iterator>::value_type::second_type, compare>", "your code should be here...");
}

template<typename compare, typename U, std::ranges::forward_range Range>
AVL_tree(Range&& range, const compare& cmp, pp_allocator<U> alloc, logger* logger)
-> AVL_tree<const typename std::iterator_traits<typename std::ranges::iterator_t<Range>>::value_type::first_type,
        typename std::iterator_traits<typename std::ranges::iterator_t<Range>>::value_type::second_type, compare>
{
    throw not_implemented("template<typename compare, typename U, std::ranges::forward_range Range>\n"
                          "AVL_tree(Range&& , const compare& , pp_allocator<U> , logger* )\n"
                          "-> AVL_tree<const typename std::iterator_traits<typename std::ranges::iterator_t<Range>>::value_type::first_type,\n"
                          "typename std::iterator_traits<typename std::ranges::iterator_t<Range>>::value_type::second_type, compare>", "your code should be here...");
}

template<typename tkey, typename tvalue, typename compare, typename U>
AVL_tree(std::initializer_list<std::pair<tkey, tvalue>> data, const compare& cmp, pp_allocator<U> alloc, logger* logger)
-> AVL_tree<tkey, tvalue, compare>
{
    throw not_implemented("template<typename tkey, typename tvalue, typename compare, typename U>\n"
                          "AVL_tree(std::initializer_list<std::pair<tkey, tvalue>> , const compare& , pp_allocator<U> , logger* )\n"
                          "-> AVL_tree<tkey, tvalue, compare>", "your code should be here...");
}

// endregion AVL_tree additional constructors
