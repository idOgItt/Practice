...
class big_int
{
    ...
    void multiply_assign_no_sign(std::vector<unsigned int>& lhs, const std::vector<unsigned int>& rhs);

    std::vector<unsigned int> multiply_common(const std::vector<unsigned int>& lhs, const std::vector<unsigned int>& rhs);

    std::vector<unsigned int> multiply_karatsuba(const std::vector<unsigned int>& lhs, const std::vector<unsigned int>& rhs);

    void divide_assign_no_sign(std::vector<unsigned int>& lhs, const std::vector<unsigned int>& rhs);

    std::vector<unsigned int> divide_common(const std::vector<unsigned int>& lhs, const std::vector<unsigned int>& rhs);

    std::vector<unsigned int> divide_newton(const std::vector<unsigned int>& lhs, const std::vector<unsigned int>& rhs);
    ...
    static std::vector<unsigned int> summ_five(unsigned int a0b0, unsigned int a1b0, unsigned int a0b1, unsigned int a1b1);

    static void move_caret(std::vector<unsigned int>& vec, unsigned int new_var);

    unsigned int find_quolitent(const std::vector<unsigned int>& numerator, const std::vector<unsigned int>& denominator);
